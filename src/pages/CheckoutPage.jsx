...
const CheckoutPage = ({totalAmount , setPriceToPay ,setCheckout}) => {
    ...
    const priceTopay = (totalAmount + 50) - ((totalAmount)*Discount)/100;
    setPriceToPay(priceTopay);
    return (
        <form 
        onSubmit={sumitHanlder}
                ...
                <div className="flex w-full sm:w-9/12 lg:w-full flex-col lg:flex-row justify-center items-center lg:space-x-10 2xl:space-x-36 space-y-12 lg:space-y-0">
                    <div className="flex w-full  flex-col justify-start items-start">
                        ...
                        <div className="mt-8 flex flex-col justify-start items-start w-full space-y-8 ">
                            <input required className="px-2 focus:outline-none focus:ring-2 focus:ring-gray-500 border-b border-gray-200 leading-4 text-base placeholder-gray-600 py-4 w-full" type="text" placeholder="First Name" />
                            <input required className="px-2 focus:outline-none focus:ring-2 focus:ring-gray-500 border-b border-gray-200 leading-4 text-base placeholder-gray-600 py-4 w-full" type="text" placeholder="Last Name" />
                            <input required className="px-2 focus:outline-none focus:ring-2 focus:ring-gray-500 border-b border-gray-200 leading-4 text-base placeholder-gray-600 py-4 w-full" type="text" placeholder="Address" />
                            <input required className="px-2 focus:outline-none focus:ring-2 focus:ring-gray-500 border-b border-gray-200 leading-4 text-base placeholder-gray-600 py-4 w-full" type="text" placeholder="Address (line 02)" />
                            ...
                            <input required className="focus:outline-none focus:ring-2 focus:ring-gray-500 px-2 border-b border-gray-200 leading-4 text-base placeholder-gray-600 py-4   w-full" type="text" placeholder="Phone Number" />
                        </div>
                        <button       
                         type="sumit"                   
                         className="focus:outline-none focus:ring-gray-500 focus:ring-offset-2 mt-8 text-base font-medium focus:ring-2 focus:ring-ocus:ring-gray-800 leading-4 hover:bg-black py-4 w-full md:w-4/12 lg:w-full text-white bg-gray-800">Proceed to payment</button>
                    </div>
                    ...
                    <div className="flex flex-col justify-start items-start bg-gray-50 w-full p-6 md:p-14">
                        ...
                        <div className="flex mt-7 flex-col items-end w-full space-y-6">
                            ...
                            <div className="flex justify-between w-full items-center">
                                ...
                                <p className="text-lg font-semibold leading-4 text-gray-600">${totalAmount}</p>
                            </div>
                            <div className="flex justify-between w-full items-center">
                            ...
                            <div className="flex justify-between w-full items-center">
                                ...
                                <p className="text-lg font-semibold leading-4 text-gray-600">${totalAmount + 50}</p>
                            </div>
                            <div className="flex justify-between w-full items-center">
                                <p className="text-lg leading-4 text-gray-600">Discount</p>
                                <p className="text-lg font-semibold leading-4 text-gray-600">{Discount}%</p>
                            </div>
                        </div>
                        <div className="flex justify-between w-full items-center mt-32">
                            <p className="text-xl font-semibold leading-4 text-gray-800">Estimated Total </p>
                            <p className="text-lg font-semibold leading-4 text-gray-800">${priceTopay}</p>
                        </div>
                    </div>
